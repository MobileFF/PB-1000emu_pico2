...
def main():
    print("========================================")
    print(" USB Host Keyboard Unified Test")
    print("========================================")
    print("Hardware Setup:")
    print("1. Use a Raspberry Pi Pico / Pico 2.")
    print("2. Connect a USB keyboard. Ensure D+/D- connections are correct")
    print("   or an OTG adapter is properly used depending on your board setup.")
    print("========================================\n")
